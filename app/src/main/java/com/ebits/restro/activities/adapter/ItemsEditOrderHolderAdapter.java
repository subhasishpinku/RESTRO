...
/**
 * Created by Mr. Satyaki Mukherjee on 16/09/16.
 */
public class ItemsEditOrderHolderAdapter extends RecyclerView
        .Adapter<ItemsEditOrderHolderAdapter.MyViewHolder> {

    private Context mContext;
    private List<ItemEditOrderModel> itemOrderModelList;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView recipeTextView, recipeRateTextView, recipeValueTextView
                , recipeQtyTextView,descriptionTextView,
                recipeId,chargableNonChargable;
        public CircularWithoutNetworkImageView foodImageView;
        public ImageButton plusQtyBtn,minusQtyBtn,descriptionBtn
                ,nonChargableBtn,deleteBtn;
    ...
    public ItemsEditOrderHolderAdapter(Context mContext, List<ItemEditOrderModel> itemOrderModelList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        final ItemEditOrderModel itemOrderModel = itemOrderModelList.get(position);
...
*/
        ...
        int ncOrC1   =   Integer.parseInt(holder.chargableNonChargable.getText().toString().trim());
        if(ncOrC1==0) {
    ...
    public void remove(ItemEditOrderModel data) {
