...
public class TableStatus extends AppCompatActivity implements SearchView.OnQueryTextListener {
...
//        addRemarksEditText = (EditText) findViewById(R.id.foodOrder_addRemarksEditText);
        ...
        TableStatus.My_async asyn = new TableStatus.My_async();
        asyn.execute();
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TableStatus.this, NavigationDrawerActivity.class);
