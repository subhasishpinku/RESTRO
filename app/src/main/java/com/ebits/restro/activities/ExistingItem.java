...
public class ExistingItem extends AppCompatActivity implements SearchView.OnQueryTextListener {
...
//        addRemarksEditText = (EditText) findViewById(R.id.foodOrder_addRemarksEditText);
    ...
    ExistingItem.My_async asyn = new ExistingItem.My_async();
        asyn.execute();
...
public void onClick(View v) {
        Intent intent = new Intent(ExistingItem.this, NavigationDrawerActivity.class);
        ...
        lv.setAdapter(new ExistingItem.My_adap(temp));
...
//        SearchView searchView = (SearchView) menu.findItem(R.id.search_kot).getActionView();
        //   SearchView searchView = (SearchView)findViewById(R.id.search_kot);
//        searchView.setSearchableInfo(searchManager.getSearchableInfo(getComponentName()));
//        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
//
//            @Override
//            public boolean onQueryTextSubmit(String kotNumber) {
//                // TODO Auto-generated method stub
//                new TableStatus.My_async().execute();
//                Toast.makeText(getBaseContext(), kotNumber,
//                        Toast.LENGTH_SHORT).show();
//                lv.setAdapter(new TableStatus.My_adap(temp));
//
//
//                return false;
//            }
...
//                    Intent ii = new Intent(TableStatus.this, EditOrderTakingActivity.class);
//
