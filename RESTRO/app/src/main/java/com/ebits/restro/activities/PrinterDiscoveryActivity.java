...
public class PrinterDiscoveryActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.printer_activity_discovery);
        ...
        mPrinterListAdapter = new SimpleAdapter(this, mPrinterList, R.layout.printer_list_at,
        ...
        try {
            ...
            PrinterShowMsg.showException(e, "start", mContext);
        }
    }
    ...
    private void restartDiscovery() {
        while (true) {
            try {
                ...
                if (e.getErrorStatus() != Epos2Exception.ERR_PROCESSING) {
                    PrinterShowMsg.showException(e, "stop", mContext);
                    return;
                }
            }
        }
